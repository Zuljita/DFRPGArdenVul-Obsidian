...
aliases:
  - Rudishva
  - Crellik-Var
  - Entertainment Officer Crellik-Var
appears_in:
...
- **Crellik-Var** — possible identity, based on the Beacon crew roster (Entertainment Officer)

## Appearance
- Larger and thinner than a human.
- Two small horns on his head.
- Wears a purple jumpsuit.
- Wears a white scarf.
- Wears a **red bracelet** (possibly a Rudishva Command Bracelet).

## Known Activities
- Hosts "Spectacle Days" at the [[locations/Arena.md|Arena]], announcing matches from his box across the arena sands.
- Presides over gladiatorial combat between fighters and arena monsters (e.g., giant beetles, manticores, chimeras, owlbears, hell hounds).

## Identification
In [[sessions/Session 46 - The Arena Lord and the Inn of the Lost.md|Session 46]], Ioannes went through the Beacon's crew roster with [[npcs/Akla-Chah.md|Akla-Chah]] and believed he recognized the Arena Lord as **Entertainment Officer Crellik-Var**. Akla-Chah confirmed that not all Beacon crew members were accounted for and that it was possible some were still alive, though the Beacon crashed a very long time ago.
