---
title: Merenuithiel Lacrymosa Armaris
tags:
  - npc
  - race/elf
  - profession/archer
...
# Merenuithiel Lacrymosa Armaris
...
### Session 43a — Alpha Strike on the Cult of Set
- Hired by Right for Riches for the Forum of Set invasion.
- Entered through the cliff-face entrance.
- Shot four of six cultists on the torchlit chasm balcony.
- Shot the last fleeing cultist out of the basket on the cliff.
- Shot multiple Settite guards and acolytes in the kitchen battle.
- Wore magical goggles to see through Settite darkness; shot multiple goggled guards.
- Shot a Settite mage who made the mistake of not knowing Blink.

### Session 43b — Alpha Strike on the Cult of Set (continued)
- Under Great Haste, kept up continuous fire as Settite reinforcements poured in.
- Survived Dobby's invisible backstab using Luck, then shot Dobby to pieces.
- In the "Last Stand of the Settites": opened with Concussion spell, then Flash and Smoke nagetempos, then sustained archery.
- Fought a long-range duel with a Settite warrior using a returning javelin; outlasted him due to superior rate of fire.
- Was exhausted after the battle; shoulder wound to [[pcs/Uvash Edzuson.md|Uvash]] left her as the only functional ranged attacker.
- Noted Stephania was cut down from behind by one of her own priests during the final battle.

### Session 43c — Looting the Cult of Set
- Assigned to guard the entry hallway while the party looted the Settite vault.
- Shot the bipedal boar construct guarding the vault three times in center mass, finishing it off.
...
### Advantages / Traits (20)

- **Appearance** [4 pts]
- **Elven Gear** [1 pts]
- **Increased Basic Move** [5 pts]
- **Increased Dexterity** [20 pts]
- **Magery** [5 pts]
- **Forest Guardian** [20 pts]
- **UB Tychias-raised elf** [1 pts]
- **Language: Elvish** [1 pts]
- **Language: Mithric** [1 pts]
- **Wealth** [30 pts]
- **Fit** [5 pts]
- **Luck** [15 pts]
- **Combat Reflexes** [15 pts]
- **No Nuisance Rolls (@Task@)** [1 pts]
- **Extra Attack** [50 pts]
- **Heroic Archer** [20 pts]
- **Weapon Master** [20 pts]
- **Strongbow** [1 pts]
- **Weapon Bond (Tears of the Forsaken)** [1 pts]
- **TM Move: L'alarme à l'oeil** [1 pts]

### Disadvantages (10)

- **Decreased Strength** [-10 pts]
- **Sense of Duty** [-15 pts]
- **Greed** [-15 pts]
- **Bloodlust** [-10 pts]
- **Sense of Duty** [-5 pts]
- **Fakes an elven accent** [-1 pts]
- **Sends souls off after combat** [-1 pts]
- **Calls buff potions energy drinks** [-1 pts]
- **Doesn't differentiate companions well** [-1 pts]
- **Likes cats** [-1 pts]

### Skills (14)

- **Bow** (dx/a) — level **23**
- **Innate Attack (Projectile)** (dx/e) — level **15**
- **Acrobatics** (dx/h) — level **13**
- **Armory (Missile Weapons)** (iq/a) — level **9**
- **Stealth** (dx/a) — level **21**
- **Stealth (vs Vision)** (dx/a) — level **23**
- **Stealth (vs Hearing)** (dx/a) — level **22**
- **Survival (Woodlands)** (per/a) — level **13**
- **Camouflage** (iq/e) — level **11**
- **Scrounging** (per/e) — level **10**
- **Fast-Draw (Arrow)** (dx/e) — level **20**
- **Fast-Draw (Potion)** (dx/e) — level **16**
- **Alchemy** (iq/vh) — level **7**
- **Body Sense** (dx/h) — level **13**

### Spells (6)

- **Concussion** — *Air, Sound* — level **9**
- **Walk on Air** — *Air* — level **8**
- **Create Air** — *Air* — level **8**
- **Shape Air** — *Air* — level **8**
- **Sound** — *Sound* — level **8**
- **Thunderclap** — *Sound* — level **8**

### Equipment (26 equipped of 26 total)

- **Cloak of the Lion**
- **Power Item 16 FP** ×16
- **Tears of the Forsaken** — in Lanyard, Leather
- **Cornucopia Quiver**
- **FB+1 Bodkin Arrow** ×25 — in Hip Quiver, Large
- **FB Cutting Arrow** ×25 — in Hip Quiver, Large
- **Dungeon Camouflage clothing**
- **Strength Potion** — in Potion Belt
- **Agility Potion** — in Potion Belt
- **Perception Potion** — in Potion Belt
- **Speed Potion** — in Potion Belt
- **Magebane** — in Potion Belt
- **Alchemist’s Fire** — in Potion Belt
- **FB Meteoric Arrow** ×3 — in Delver’s Webbing
- **FB Meteoric Bodkin** ×3 — in Delver’s Webbing
- **Rainbow Bodkin +1/+2/+2/+2(8) dmg** ×3 — in Delver’s Webbing
- **FB+ Silvered Arrow** ×3 — in Delver’s Webbing
- **Alchemist’s Matches** — in Delver’s Webbing
- **Nageteppo, Smoke** ×2 — in Delver’s Webbing
- **Nageteppo, Flash** ×2 — in Delver’s Webbing
- **Caltrops** ×2 — in Delver’s Webbing
- **Hand Mirror** — in Delver’s Webbing
- **Iron Spike** — in Delver’s Webbing
- **Ancient Silver Penny** ×9 — in Delver’s Webbing
- **Archontean Gold Piece** ×3 — in Delver’s Webbing
- **Boots of Elvenkind**
