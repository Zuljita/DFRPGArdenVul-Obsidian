...
* **Exploration Path:** Utilize the Rugs to reach the Beacon, then use the [[items/Rudishva Teleportation Pad.md|Rudishva Teleportation Pad]] to reach the Vault. The route will proceed through the acidic pool room and the room containing the Chaotic Sweat.
