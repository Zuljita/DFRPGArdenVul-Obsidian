---
title: "Discord Summary 2026-W21"
tags:
  - discord-summary
  - canonical-source
week_ending: 2026-05-29
source_type: private-discord-weekly-digest
source_week: week-ending-2026-05-29-2300-central
---

# Discord Summary 2026-W21
...
**Week Ending:** 2026-05-29 23:00 CDT

**Summary**
The company Chrysalis focused heavily on logistics, research, and preparation within the safety of town. While significant progress was made in upgrading equipment and expanding magical knowledge, several investigations into local legends and historical lineages yielded both startling revelations and frustrating dead ends.
...
* **Town actions taken:** 
    * Conducted promotional efforts within the [[locations/Goblin Market.md|goblin market]] to increase local awareness of company services.
...
**World Rulings**
* **Spell Mechanics (Area):** Area spells extend 4 yards upward; vertical expansion is fixed unless obstructed by impassable objects.
* **Spell: Knit Bones:** A Clerical spell (PI 5) that restores crippled body parts, hearing, sight, memory, and speech, and stops paralysis/spasms; however, it does not restore HP or cure poisons, diseases, or curses.
* **Spell: Warding Chain of Glyphs:** A Fire-based Area spell (Clerical PI 5). The caster inscribes up to PI glyphs on a surface; they are invisible after casting and deal 1d burning damage per glyph upon trigger. Each trigger consumes one glyph.
* **Item Weights:** Short scrolls weigh 1/20th lb; rings weigh 1/50th lb; data crystals weigh 0.2 lbs (naked) or 0.5 lbs (in protective cases). Books have variable weights (e.g., *Book of Priors* is 14 lbs).
* **Currency:** Platinum coins are large (2" diameter, 1/2" thick), weighing 1.5 lbs each.
...
2. Utilize the first set of [[items/Rugs of Instant Access.md|Rugs of Instant Access]] to travel to the Beacon.
 $\text{Use}$ the [[items/Rudishva Teleportation Pad.md|Rudishva Teleportation Pad]] to reach the [[locations/Cloister.md|Cloister]], proceeding through secret passages (southwest, then north along water, then east).
