...
- [ ] **Fight the renegade Varumani**
  - ID: `fight-renegade-varumani`
  - Status: active
  - Summary: Engage the Varumani group that refused to respect the party's passport.
  - Next step: Confront the renegade Varumani.
  - Evidence:
...
- [ ] **Clear area south of Goblin Forum**
  ...
  - Status: active
  - Summary: Continue clearing the area south of the Goblin Forum to make it safer for commerce.
  - Next step: Continue clearing the area south of the Forum.
  - Evidence:
...
- [ ] **Monitor Kerbog Khan's activities**
  - ID: `investigate-kerbog-khan`
  - Status: watch
  - Summary: Keep an eye on Kerbug Khan due to reports of kidnapping and medical experimentation.
  - Related: [[npcs/Kerbog Khan.md|Kerbog Khan]]
  - Evidence:
    - [[sessions/Session 52b and 53 - Behir, Varumani, and the Surgical Construct.md|Session 52b and 53 - Behir, Varumani, and the Surgical Construct]] — "It appears he kidnaps varumani and does medical experiments on them without permission."

- [ ] **Check Cloister area for loot**
  - ID: `check-cloister-loot`
  - Status: watch
  - Summary: Return to the Cloister area to ensure all loot is collected before Kerbog Khan's spies arrive.
