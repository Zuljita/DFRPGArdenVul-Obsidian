...
**Contents:**
- Approximately **40 books** and **20 scrolls** — a major cache of Thothian knowledge.
- **Scrawled notes on the table**, including a letter from someone named **Hellas** to **[[npcs/Neferet.md|Neferet]]**, accusing her of:
  - Necromancy
  - Stealing "some Archon's circlet" (likely the [[items/Iron Circlet of Ghanor.md|Iron Circlet of Ghanor]])
  - The letter denies Neferet access to the secret library, saying her quarters near the [[locations/Great Hall.md|Great Hall]] were "too exposed."
...
- Contains a path to the librarian's chamber with a fear trap.
- The main library door is locked (Vallium had the key as of Session 37).
...
## Discord Insights
- Located near the Well of Light, contains lost and valuable knowledge, guarded by undead. ([[notes/Discord Summary 2025-W30.md|Discord Summary 2025-W30]])
- A Thothian feature that R4R has uncovered. ([[notes/Discord Summary 2025-W34.md|Discord Summary 2025-W34]])
