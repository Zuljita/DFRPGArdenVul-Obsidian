...
- **Pursue magical research**: Vael holds Tresti's spellbook, which contains the [[The Bracteros Effect|Bracteros Effect]] — a Light and Darkness spell that renders a light source invisible to observers more than seven hexes away — along with Basil's Torch Treatment and Frigg's Elephant Ears. Integration of these into his repertoire is ongoing.
- **Identify and deal with his Gift from Set**: An item acquired from the [[Cult of Set]] was identified as "Vael's Gift from Set"; it required identification work. The status of this item and whether it represents an obligation or threat is unresolved.
...
- **[[Wicktrimmer]]**: Wealthy goblin merchant, head of the Rarities Factor, retired adventurer, and one of the most powerful figures in Gosterwick. He purchased [[Larel's Pin]] from the Right for Riches company and has persistently attempted to buy a pair of teleport rugs from them. He has intelligence on enemy activities and a network that watches for new magic items entering town. The relationship is transactional and mildly tense — valuable to both sides but neither fully trusts the other's agenda.
...
- **[[Weskenim]]**: King of the United Goblin Tribes. The party's relationship with him began when they freed his brother [[Gribble]] from Settite captivity in the [[sessions/Session 23c - Set Jailbreak and Down to Goblintown.md|Set Jailbreak]]; Gribble led the party back to Goblintown to meet the king, who promised rewards on their next visit. The party has subsequently worked to stabilize the Goblin Forum's economy by seeding it with food merchants from Gosterwick.
- **[[Five Fingers of Destiny]]**: Rival adventuring company led by [[Roger the Rapier]], a mage. The two groups made a deal — Roger showed R4R the approach to the Thothian treasury in exchange for a silver ankh key, while R4R warned them away from the Beacon. Vael treats them as a manageable risk but not friends.
...
- [[sessions/Session 40 - Taking Command.md|Session 40]]: found the Command Tablet in the Rudishva Bastion and plugged it into the bridge console. Addressed as "Captain" by both the ship computer and Akla-Chah. Named Ioannes, Vallium, and Uvash as officers; designated Basil of Narsileon as crew.
- [[sessions/Session 43a - Alpha Strike on the Cult of Set.md|Session 43a]] through [[sessions/Session 43c - Looting the Cult of Set.md|Session 43c]]: participated in the destruction of the Cult of Set's temple presence, looting their vault (after Lockmaster bypassed their locks), and freeing enslaved prisoners.
...
- **Language: Varumani - Spoken Accented** [2 pts]
- **Language: Archontean - Spoken Accented** [2 pts]
- **Language: @Language@ Spoken Accented/Written Broken** [3 pts]
...
- **Alchemy** (iq/vh) — level **12**
- **Body Sense** (dx/h) — level **12**
- **Camouflage** (iq/e) — level **15**
- **Cartography** (iq/a) — level **14**
- **Connoisseur (Art)** (iq/a) — level **14**
- **Connoisseur (Luxuries)** (iq/a) — level **14**
- **Connoisseur (Weapons)** (iq/a) — level **14**
- **Detect Lies** (per/h) — level **14**
- **Diplomacy** (iq/h) — level **15**
- **Fast-Talk** (iq/a) — level **16**
- **Hidden Lore (Magical Writings)** (iq/a) — level **14**
- **Innate Attack (Projectile)** (dx/e) — level **7**
- **Intimidation** (will/a) — level **15**
- **Merchant** (iq/a) — level **14**
- **Mimicry (Speech)** (iq/h) — level **11**
- **Navigation** (iq/a) — level **13**
- **Observation** (per/a) — level **15**
- **Performance** (iq/a) — level **12**
- **Prospecting** (iq/a) — level **14**
- **Public Speaking** (iq/a) — level **15**
- **Search** (per/a) — level **15**
- **Sex Appeal** (ht/a) — level **9**
- **Singing** (ht/e) — level **8**
- **Staff** (dx/a) — level **6**
- **Stealth** (dx/a) — level **10**
- **Streetwise** (iq/a) — level **14**
- **Thaumatology** (iq/vh) — level **17**
- **Traps** (iq/a) — level **14**
- **Writing** (iq/a) — level **14**

### Spells (68)

- **Create Air** — *Air* — level **18**
- **Lightning** — *Air, Weather* — level **18**
- **Purify Air** — *Air* — level **18**
- **Shape Air** — *Air* — level **18**
- **Walk on Air** — *Air* — level **18**
- **Wall of Lightning** — *Air, Weather* — level **18**
- **Windstorm** — *Air* — level **18**
- **Earth to Air** — *Air, Earth* — level **18**
- **Seek Earth** — *Earth* — level **18**
- **Shape Earth** — *Earth* — level **18**
- **Create Fire** — *Fire* — level **18**
- **Extinguish Fire** — *Fire* — level **18**
- **Ignite Fire** — *Fire* — level **18**
- **Shape Fire** — *Fire* — level **18**
- **Smoke** — *Fire* — level **18**
- **Scry Gate** — *Gate* — level **18**
- **Seek Gate** — *Gate* — level **18**
- **Lend Energy** — *Healing, Meta* — level **18**
- **Recover Energy** — *Healing, Meta* — level **18**
- **Analyze Magic** — *Knowledge* — level **18**
- **Detect Magic** — *Knowledge* — level **18**
- **Glass Wall** — *Knowledge* — level **18**
- **Identify Spell** — *Knowledge* — level **18**
- **Mage Sight** — *Knowledge* — level **18**
- **Pathfinder** — *Knowledge* — level **18**
- **Seek Magic** — *Knowledge, Meta* — level **18**
- **Seeker** — *Knowledge* — level **18**
- **Trace** — *Knowledge* — level **18**
- **Wizard Eye** — *Knowledge* — level **18**
- **Blur** — *Light & Darkness* — level **18**
- **Colors** — *Light & Darkness* — level **18**
- **Continual Light** — *Light & Darkness* — level **18**
- **Darkness** — *Light & Darkness* — level **18**
- **Infravision** — *Light & Darkness* — level **18**
- **Invisibility** — *Light & Darkness* — level **18**
- **Light** — *Light & Darkness* — level **18**
- **See Invisible** — *Light & Darkness* — level **18**
- **The Bracteros Effect** — *Light and Darkness* — level **18**
- **Copy** — *Making & Breaking* — level **18**
- **Find Weakness** — *Making & Breaking* — level **18**
- **Rejoin** — *Making & Breaking* — level **18**
- **Repair** — *Making & Breaking* — level **18**
- **Restore** — *Making & Breaking* — level **18**
- **Weaken** — *Making & Breaking* — level **18**
- **Counterspell** — *Meta* — level **18**
- **Dispel Magic** — *Meta* — level **18**
- **Daze** — *Mind Control* — level **18**
- **Foolishness** — *Mind Control* — level **18**
- **Keen Vision** — *Mind Control* — level **18**
- **Mass Daze** — *Mind Control* — level **18**
- **Apportation** — *Movement* — level **18**
- **Blink** — *Gate, Movement* — level **18**
- **Blink Other** — *Gate, Movement* — level **17**
- **Flight** — *Movement* — level **17**
- **Grease** — *Movement* — level **18**
- **Great Haste** — *Movement* — level **17**
- **Haste** — *Movement* — level **18**
- **Levitation** — *Movement* — level **18**
- **Lockmaster** — *Movement* — level **18**
- **Magelock** — *Protection & Warning* — level **18**
- **Missile Shield** — *Protection & Warning* — level **18**
- **Concussion** — *Air, Sound* — level **18**
- **Great Voice** — *Sound* — level **13**
- **Message** — *Communication & Empathy, Sound* — level **18**
- **Sound** — *Sound* — level **18**
- **Thunderclap** — *Sound* — level **18**
- **Voices** — *Sound* — level **18**
- **Seek Water** — *Water* — level **18**

### Equipment (16 equipped of 17 total)

- **Clothing**
- **Wizard’s Staff**
- **The Captain's Broadside**
- **Red Rudishva Command Bracelet**
- **Magic Pearl of Energy Reserve (+3)**
- **Lucky Penny**
- **Larel's Heavy Cloak**
- **Wand of See Secrets** — in Delver’s Webbing
- **Visibility Dust** — in Delver’s Webbing
- **Potion of Dispelling** — in Delver’s Webbing
- **Paut** — in Delver’s Webbing
- **Glow Vial** — in Delver’s Webbing
- **Ebony Wand of Magical Bolt** — in Delver’s Webbing
- **Alchemist’s Fire** — in Delver’s Webbing
- **Bracers of Force +3**
