...
- [[sessions/Session 7 - Why Did It Have to Be Plants.md|Session 7 - Why Did It Have to Be Plants?]] — Date: Demmasday, 25th of Lucrios, 2993 AEP Weather: Cool, light rain Player Characters: Ioannes Grammatikos Byzantios, Archontean cleric of [[npcs/Demma.md|Demma]] (Demented Avenger) Vallium Halcyon, Archontean fighter Uvash Edzuson, Dwarven c...
- [[sessions/Session 8a - Never Trust a Scorpion.md|Session 8a - Never Trust a Scorpion]] — # DFRPG [[locations/Arden Vul.md|Arden Vul]] Session 8a: Never Trust a Scorpion Date: Demmasday, 2nd of Ligarios, 2993 AEP Weather: Cool, rainy Player Characters: Ioannes Grammatikos Byzantios, Archontean cleric of [[npcs/Demma.md|Demma]] (Demented Avenger) Vallium Halcyon, Archont...
- [[sessions/Session 8b and 9 - Muirasso's Tomb and the Broken Head.md|Session 8b and 9 - Muirasso's Tomb and the Broken Head]] — # DFRPG [[locations/Arden Vul.md|Arden Vul]] Sessions 8b and 9: [[locations/Muirasso's Tomb.md|Muirasso's Tomb]] and the Broken Head Date: Demmasday, 2nd of Ligarios and Demmasday, 9th of Legarios, 2993 AEP Weather: Cool, cloudy Player Characters: Ioannes Grammati...
- [[sessions/Session 10 - Baboons, Ghouls, and a Mule.md|Session 10 - Baboons, Ghouls, and a Mule]] — # DFRPG [[locations/Arden Vul.md|Arden Vul]] Session 10: Baboons, Ghouls, and a Mule Date: Demmasday, 16th of Ligarios, 2993 AE Weather: Warm, overcast Player Characters: Ioannes Grammatikos Byzantios, Archontean cleric of [[npcs/Demma.md|Demma]] (Demented Avenger) Vallium Halcyon,...
...
- [[attachments/discord/character-sheets/1354520220798025840-Ioannes.gcs|Ioannes.gcs]] — source: `#character-sheets` (2025-03-26)
- [[attachments/discord/character-sheets/1352789253356130334-Ioannes.gcs|Ioannes.gcs]] — source: `#character-sheets` (2025-03-21)
- [[attachments/discord/character-sheets/1349934492504162374-Ioannes.gcs|Ioannes.gcs]] — source: `#character-sheets` (2025-03-14)
- [[attachments/discord/character-sheets/1508136174038814982-Ioannes20260529.gcs|Ioannes20260529.gcs]] — source: `#character-sheets` (2026-05-24)
...
- **Name:** Ioannes Grammatikos Byzantios
- **Age:** 32
- **Height:** 5'7"
- **Weight:** 145 lb
- **Tech Level:** 3
...
- **Curious** [-5 pts]
- **Sense of Duty** [-5 pts]
- **Sense of Duty** [-10 pts]
- **Broad-Minded** [-1 pts]
- **Careful** [-1 pts]
- **Dislike (Charlatans & Fake Prophets)** [-1 pts]
- **Dorky** [-1 pts]
- **Hopeless romantic** [-1 pts]

### Skills (22)

- **Alchemy** (iq/vh) — level **13**
- **Animal Handling (Equines)** (iq/a) — level **15**
- **Animal Handling (Felines)** (iq/a) — level **15**
- **Axe/Mace** (dx/a) — level **12**
- **Climbing** (dx/a) — level **9**
- **Diagnosis** (iq/h) — level **14**
- **Esoteric Medicine (Holy)** (per/h) — level **14**
- **Exorcism** (will/h) — level **16**
- **First Aid** (iq/e) — level **16**
- **Gesture** (iq/e) — level **16**
- **Hiking** (ht/a) — level **12**
- **Naturalist** (iq/h) — level **14**
- **Occultism** (iq/a) — level **15**
- **Propaganda** (iq/a) — level **15**
- **Religious Ritual** (iq/h) — level **14**
- **Research** (iq/a) — level **15**
- **Search** (per/a) — level **15**
- **Shield (Shield)** (dx/e) — level **12**
- **Stealth** (dx/a) — level **11**
- **Surgery** (iq/vh) — level **13**
- **Swimming** (ht/e) — level **13**
- **Theology** (iq/h) — level **14**

### Spells (20)

- **Affect Spirits** — *Necromancy* — level **19**
- **Awaken** — *Healing* — level **19**
- **Bless** — *Meta* — level **19**
- **Bravery** — *Mind Control* — level **19**
- **Command** — *Mind Control* — level **19**
- **Flaming Weapon** — *Fire* — level **19**
- **Gift of Letters** — *Communication & Empathy* — level **18**
- **Gift of Tongues** — *Communication & Empathy* — level **18**
- **Lend Energy** — *Healing, Meta* — level **19**
- **Major Healing** — *Healing* — level **18**
- **Minor Healing** — *Healing* — level **19**
- **Recover Energy** — *Healing, Meta* — level **19**
- **See Secrets** — *Knowledge* — level **19**
- **Shield** — *Protection & Warning* — level **19**
- **Stop Bleeding** — *Healing* — level **19**
- **Apportation** — *Movement* — level **15**
- **Continual Light** — *Light & Darkness* — level **15**
- **Ignite Fire** — *Fire* — level **15**
- **Light** — *Light & Darkness* — level **15**
- **Seek Earth** — *Earth* — level **15**

### Equipment (14 equipped of 14 total)

- **Clothing**
- **Adventuring License Bronze Token**
- **Cloak of the Bat**
- **Holy Symbol, High**
- **Bracers of Force +3**
- **Salamander Amulet**
- **Small Axe** — in Lanyard, Leather
- **Wizard’s Wand**
- **Ring of Protection +1**
- **Ring of Energy Reserve 3 (clerical)**
- **Medium Shield**
- **Healing Potion, Major** ×2 — in Potion Belt
- **Paut** ×2 — in Potion Belt
- **Belt of Dwarvenkind**
