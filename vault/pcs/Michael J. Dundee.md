...
_Generated from `1367555339255418960-Michael_J_Dundee.gcs` (sheet `modified_date`: **2025-05-01**, total points: **142**)._

- **Name:** Michael J Dundee
- **Age:** 21
- **Height:** 5'6"
- **Weight:** 180 lb
- **Tech Level:** 3
...
- **Signature Gear (@Weapon@)** [1 pts]
- **Tough Skin** [3 pts]
- **Weapon Bond (@Specific Weapon@)** [1 pts]
- **Increased Strength** [10 pts]
...
- **Lifting ST** [3 pts]
- **Striking ST** [5 pts]
- **Language: Archontean (Accented Spoken)** [2 pts]
...
- **Quirk 1: Catchphrase** [-1 pts]
- **Quirk 2: All women are "Sheila"** [-1 pts]
- **Quirk 3: Always catches the biggest fish** [-1 pts]
- **Quirk 4: Raised by Aborigines** [-1 pts]
- **Quirk 5: Scar on leg from Slorn "love bite"** [-1 pts]

### Skills (13)

- **Stealth** (dx/a) — level **8**
- **Tracking** (per/a) — level **9**
- **Swimming** (ht/e) — level **7**
- **Camouflage** (iq/e) — level **10**
- **Survival (Swampland)** (per/a) — level **9**
- **Brawling** (dx/e) — level **13**
- **Tactics** (iq/h) — level **8**
- **Fast-Draw (Boomerang)** (dx/e) — level **13**
- **Fast-Draw (Sword)** (dx/e) — level **13**
- **Shield (Shield)** (dx/e) — level **13**
- **Thrown Weapon (@Specialty@)** (dx/e) — level **13**
- **Wrestling** (dx/a) — level **11**
- **Broadsword** (dx/a) — level **15**

### Equipment (18 equipped of 18 total)

- **Clothing** [2 lb]
- **Belt** [0.5 lb] — $15
- **Boomerang** [1 lb] — $20 — in Bandoleer
- **Cord, 3/16”** [0.5 lb] — $1 — in Backpack, Small
- **Pole, 6’** [3 lb] — $5 — in Backpack, Small
- **Chalk** [0.25 lb] — $1 — in Backpack, Small
- **Glow Vial** [0.5 lb] — $30 — in Backpack, Small
- **Rations** ×6 [0.5 lb] — $2 — in Backpack, Small
- **Water** [8 lb] — in Wineskin
- **Personal Basics** [1 lb] — $5 — in Backpack, Small
- **Lanyard, Leather** [0.1 lb] — $1
- **Longsword (Giant's Knife)** [4 lb] — $700
- **Scale Body Armor** [29.4 lb] — $578 — in Scale Suit
- **Scale Boots** [9.8 lb] — $192 — in Scale Suit
- **Scale Gloves** [2.8 lb] — $55 — in Scale Suit
- **Scale Helmet** [7 lb] — $138 — in Scale Suit
- **Scale Leggings** [21 lb] — $412 — in Scale Suit
- **Scale Sleeves** [14 lb] — $275 — in Scale Suit
