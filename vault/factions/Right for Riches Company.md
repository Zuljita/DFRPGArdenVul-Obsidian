...
- **[[npcs/Basil.md|Basil of Narsileon]]** — Young Archontean man from Narsileon, rescued from the Tower of the Ape's slave-training operation. Hired as non-combat Beacon support crew; formally designated crew by Vael's officer assignments to Akla-Chah in [[sessions/Session 40 - Taking Command.md|Session 40]].

### Recurring Mercenaries

- **[[Thrainor "Thronebreaker" Ironvein]]** — Dwarven mercenary fighter. A frequent combat hire who functions effectively as a matched front-line pair with Vallium; the two have fought together across multiple recent sessions including the audience with Varboka in Session 55.

## Assets

### The Beacon

The [[Beacon]] (official name: the Shining Beacon) is a crashed [[Rudishva]] starship and the company's fortified base of operations inside Arden Vul. Vael holds command authority as Captain, recognized by the ship's AI psychologist [[Akla-Chah]] after he inserted the Command Tablet into the bridge console in [[sessions/Session 40 - Taking Command.md|Session 40]]. Ioannes, Vallium, and Uvash are named officers; Basil is crew.

The ship is not yet operational — it requires fuel to fly. Known systems include the Repli-Cube (food/goods replication), the Point Defense Array, view screens capable of displaying remote locations inside Arden Vul, and an auditorium with a northern hologram dais. The surviving crew member [[Akla-Chah]] serves as an onboard AI advisor accessible via Vael's Red Rudishva Command Bracelet. A second Command Bracelet exists and its location was mapped by the goblin artist [[Temrin]].

The Five Fingers of Destiny were caught scouting above the Beacon; Vael and Ioannes subsequently researched anti-scrying and anti-teleportation countermeasures, with Ioannes locating a text on lead-lined walls as a solution ([[sessions/Session 46 - The Arena Lord and the Inn of the Lost.md|Session 46]]).
...
Beginning in [[sessions/Session 44 - Clearing the Goblin Forum.md|Session 44]], the company established a regular practice of purchasing food in Gosterwick and transporting it via Teleport Rug to the Goblin Forum to support commercial revival. [[Gribble]], Lord of the Goblin Forum, assigned [[Dworm]] (Galadnor's guard) to run the food stall until a proper merchant could be established. Ioannes has also used Propaganda-15 to seed interest in the Forum among Gosterwick merchants as a genuine commercial opportunity.
...
### Return the Second Tablet of the Beacon (Ongoing)
...
- **Destruction of the Cult of Set** — The company conducted a sustained multi-session campaign against the Cult of Set's presence in Arden Vul, culminating in an alpha strike across Sessions 43a–43c that routed the cultists, freed enslaved humans, goblins, and beastmen, and looted the Settite vault (requiring Lockmaster to bypass the third lock). High Priestess Stephania and her forces were decisively defeated.
- **Liberation of the Goblin Forum** — By clearing the Cult's hold over the Goblin Forum and re-establishing food supply, the company effectively revived the Forum as a functioning economic node under Gribble's governance. Weskenim's court and the goblin populace both benefited.
- **Securing the Beacon** — Located the Command Tablet (Session 40), established command authority over the crashed Rudishva starship, named officers and crew, and developed anti-scrying countermeasures to prevent rival access.
- **Rescue of Gevorda** — The company encountered and assisted [[Gevorda]], a Varumani woman who had been subjected to experiments by [[Kerbog Khan]]'s Surgical Construct (Sessions 52b–53). This rescue established the personal connection with Varboka that produced the Session 55 commission.
...
Company members wear cloth patches commemorating significant campaign achievements. Known patches include:

- **Halfling-Killer Patch** — Carried by Vallium; commemorates an early campaign milestone.
- **Goblin Scepter Patch** — Commemorates the Scepter of the Goblins retrieval ([[sessions/Session 35 - The Scepter - Flute of the Goblins.md|Session 35]]).
- **11 Tankards Patch** — Commemorates an unspecified milestone involving eleven tankards.

The patches are worn on clothing, functioning as a visible record of company history.
